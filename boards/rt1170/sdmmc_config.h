...
#define BOARD_SDMMC_SD_CD_GPIO_INSTANCE 3
...
#define BOARD_SDMMC_SD_POWER_RESET_GPIO_INSTANCE 10
#define BOARD_SDMMC_SD_POWER_RESET_GPIO_PIN 2U
#ifdef EVK_RT1170_BOARD
#define BOARD_SDMMC_SD_POWER_RESET_LVL_ON  1U
#define BOARD_SDMMC_SD_POWER_RESET_LVL_OFF 0U
#else /* EVKB */
#define BOARD_SDMMC_SD_POWER_RESET_LVL_ON  0U
#define BOARD_SDMMC_SD_POWER_RESET_LVL_OFF 1U
#endif
/*! @brief SD IO voltage */
